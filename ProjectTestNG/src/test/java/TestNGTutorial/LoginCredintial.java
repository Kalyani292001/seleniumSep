...
public class LoginCredintial {
	...
	public void wrongCredential() {
		driver.findElement(By.id("user-name")).sendKeys("standard_user");
		driver.findElement(By.id("password")).sendKeys("sect_sauce");
		driver.findElement(By.id("login-button")).click();

		boolean errorMsg = driver
				.findElement(By.cssSelector(
						"#login_button_container > div > form > div.error-message-container.error > h3 > button > svg"))
				.isDisplayed();
